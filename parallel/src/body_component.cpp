...
void BodyComponent::initialize() {
    std::cout << "Initializing BodyComponent..." << std::endl;
    ...
    std::cout << "BodyComponent initialized successfully" << std::endl;
}
...
float BodyComponent::processInput(float input) {
    float output = 0.0f;
...
void BodyComponent::setDamping(float newDamping) {
    if (newDamping < 0.0f) {
...
void BodyComponent::setMasterGain(float gain) {
    masterGain = gain;
...
void BodyComponent::initializeMaterialPresets() {
...
void BodyComponent::setupFiltersForMaterial(const std::string& material) {
...
void BodyComponent::adjustFiltersForDimensions() {
